package com.schedule_service.controllers;
...
public class ScheduleController {
    ...
    public ResponseEntity<List<ScheduleDTO>> getByCourse(@PathVariable Long courseId) {
        return ResponseEntity.ok(scheduleService.getSchedulesByCourse(courseId));
    }

    @GetMapping("/batch/{batchId}")
    public ResponseEntity<List<ScheduleDTO>> getByBatch(@PathVariable Long batchId) {
        return ResponseEntity.ok(scheduleService.getSchedulesByBatch(batchId));
    }
