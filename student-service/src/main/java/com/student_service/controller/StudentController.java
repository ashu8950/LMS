...
public class StudentController {
    ...
    public ResponseEntity<String> enroll(@PathVariable Long id, @RequestBody EnrollmentRequest req) {
        studentService.enrollStudent(id, req);
        return ResponseEntity.ok("Enrolled successfully");
    }

    @PostMapping("/{id}/feedback")
    public ResponseEntity<Void> submitFeedback(@PathVariable Long id, @RequestBody FeedbackDto dto) {
